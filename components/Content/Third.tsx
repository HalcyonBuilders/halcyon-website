      ...
      <div className="min-h-[900px] pt-[30px] delaGothicOne">
        <div className="h-[325px] w-[300px] md:w-[600px] brightness-[0.90] rounded-lg mx-auto relative overflow-hidden z-0">
          ...
          <div className="relative bg-[#ececec] h-1 rounded-full">
            <div
              className={`h-full w-full bg-gradient-to-r from-[#b8a7fc] via-[#48b1c5] to-[#008eab] bg-blue-300
              inset-0 absolute rounded-full ${roadmapSlide()} transition-transform duration-700 ease-out z-20`}></div>
          </div>
          <div className="">
